...
The game should feel like a blend of chess, collectible card games, and mythic civilization strategy: easy to understand at the surface, but deep enough that every move, card choice, and board position matters.
...
| Mount | White Siberian Tiger | Fast, dangerous mount with a charge attack after moving in a straight line |
...
| White Siberian Tiger | Mount | 4 | 2 | 4 | 1 | Passive: Pounce makes this character's attack deal +1 damage if it moved at least 3 tiles in a straight line this turn. | +1 HP. Pounce also pushes the target 1 tile if possible. | Snow Stalker: Once per turn, ignores the first 1 damage it would take after moving. |
...
- A character levels up by progressing all the way to the opponent's edge of the board.
...
- Each character has 3 levels.
- Characters level up during a match by reaching the opponent's edge of the board.
...
2. Write 10-20 starter shared relic/event cards.
3. Paper test the 14 character cards and record which pieces feel too strong, too weak, or too confusing.
4. Revise stats and level upgrades after 3-5 paper matches.
5. Build the first Godot rules prototype.
